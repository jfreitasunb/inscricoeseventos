...
%====================================================================
\def\coordgeral{Giovany Figueiredo (UnB)} %coordenador geral 1
\def\coordgerali{Raimundo Bastos (UnB)} %coordenador geral 2
\def\coordgeralii{Marcos Pimenta (Unesp)} %coordenador geral 3
%==================================================================== 
\def\coordalgebratn{Emerson de Melo} %coordenador de algebra
\def\coordanalise{Jaqueline G. Mesquita} %coordenador de analise
\def\coordedumat{Regina da Silva Pina Neves} %coordenador de ed matematica
\def\coordgeometria{Tarc\'{i}sio Casto} %coordenador de geometria
\def\coordmataplic{-} %coordenador de mat aplicada
\def\coorddinflui{Yuri Dumaresq Sobral} %coordenador de din de fluidos
\def\coordprobab{Paulo Henrique P. da Costa} %coordenador de probabilidade
\def\coordsistdin{Andr\'{e} Caldas} %coordenador de sist dinamicos
